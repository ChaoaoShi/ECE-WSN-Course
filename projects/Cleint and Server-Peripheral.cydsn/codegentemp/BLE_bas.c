...
const CYBLE_BASS_T cyBle_bass[0x01u] = {
    {
        0x000Cu, /* Handle of the BAS service */ 
        0x000Eu, /* Handle of the Battery Level characteristic */ 
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Characteristic Presentation Format descriptor */ 
